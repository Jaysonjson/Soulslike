...
public class SoulDrainRenderer extends SmartBlockEntityRenderer<SoulDrainBlockEntity> {

    public SoulDrainRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(SoulDrainBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
