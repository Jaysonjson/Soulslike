...
public class BottleOfSoulsItem extends Item {
    public BottleOfSoulsItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41196_, Player p_41197_, InteractionHand p_41198_) {
        ...
        if (!p_41196_.isClientSide) {
            ThrownSoulBottle thrownexperiencebottle = new ThrownSoulBottle(p_41196_, p_41197_);
