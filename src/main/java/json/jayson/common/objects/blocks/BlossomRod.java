...
import json.jayson.common.registries.SoulsParticles;
...
public class BlossomRod extends EndRodBlock {
    public BlossomRod(Properties p_53085_) {
        super(p_53085_);
    }
    ...
    public void animateTick(BlockState p_221107_, Level p_221108_, BlockPos p_221109_, RandomSource p_221110_) {
        ...
        if (p_221110_.nextInt(5) == 0) {
            p_221108_.addParticle(SoulsParticles.BLOSSOM_ROD.get(), d0 + (double)direction.getStepX() * d3, d1 + (double)direction.getStepY() * d3, d2 + (double)direction.getStepZ() * d3, p_221110_.nextGaussian() * 0.005D, p_221110_.nextGaussian() * 0.005D, p_221110_.nextGaussian() * 0.005D);
        }
    }
}
