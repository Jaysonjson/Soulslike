package org.soulslike.client.overlay.block_overlay;
...
public class BlockTextOverlay /*extends EntityTextOverlay*/ {

    public static List<BlockTextOverlay.Entry> TEXTS = new ArrayList<>();
    public static final IGuiOverlay HUD = ((gui, guiGraphics, partialTick, screenWidth, screenHeight) -> {
        ...
        for (BlockTextOverlay.Entry entry : TEXTS) {
            Minecraft minecraft = Minecraft.getInstance();
